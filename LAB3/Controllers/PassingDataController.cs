...
namespace LAB3.Controllers
{
    public class PassingDataController : Controller
    {
        ...
        {
            TempData["message1"] = "TempData có thể truyền dữ liệu từ request hiện tại tới chuỗi các request con khi sử dụng edirect";
            ...
            //return Redirect("~/PassingData/ViewBagTest.cshtml");
        }
